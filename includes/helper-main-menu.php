...
if($responsive)
{
	...
	echo '<a id="advanced_menu_hide" href="#" 	'.av_icon_string('close').'></a>';
						...
						*/
						    ...
						    echo "<nav id='nav-main' class='main_menu' data-selectname='".__('Select a page','avia_framework')."' ".avia_markup_helper(array('context' => 'nav', 'echo' => false)).">";
		...
		?>
				 ...
				 <div class='container'>
					...
					<div class='inner-container'>
                    	<a href="/" id="logo-main">HomeMade</a>
						<?php
						/*
